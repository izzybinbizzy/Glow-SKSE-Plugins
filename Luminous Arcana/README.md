...
Luminous Arcana and Let There Be Glow are never used together; Let There Be Glow ships an xEdit
patcher rather than a plugin. Every change, and how long the load pass took, is written
to `LuminousArcana.log`.

The source is generated by the mod's own build tool.
